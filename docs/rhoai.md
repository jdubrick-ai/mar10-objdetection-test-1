...
3) Access the `workbench` named `mar10-objdetection-test-1-notebook`.
...
5) In the terminal, run `cd mar10-objdetection-test-1` to navigate to your sample app's directory.
